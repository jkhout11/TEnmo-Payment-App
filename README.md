...
###  Secondary server-side use cases 
...
### Secondary - client-side use cases (complete only after all server-side items have been completed)

If you complete all of the primary and secondary server-side use cases and are looking for yet another challenge, create a Command Line Interface (CLI) client application for TEnmo. The file CLI.md contains sample user experiences for inspiration. 
